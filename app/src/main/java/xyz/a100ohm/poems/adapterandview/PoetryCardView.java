 ...
 */
public class PoetryCardView extends FrameLayout implements ViewEveryDayInterface {
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        //x0 = midCardX + DisplayUtils.dip2px(getContext(), dp);
        ...
        switch (ev.getAction()){
            ...
            case MotionEvent.ACTION_UP:
                if(isStart) {
                    ...
                    L.d("用户点击");
                    cancelTouchEvent();
                    L.e("child2 tag: " + getChildAt(2).getTag());
                    notifyClickListeners((String)getChildAt(2).getTag());
                }
                break;
    ...
    public interface OnClickListener{
        /**
         * 点击时候的的处理
         * @param poetryId 当前点击的诗句
         */
        void onClick(String poetryId);
    }
    ...
    //通知所有点击倾听者，表示用户点击这句诗
    private void notifyClickListeners(String poetryId) {
        if(onClickListeners == null)
            return;
